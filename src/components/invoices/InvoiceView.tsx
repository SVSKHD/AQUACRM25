...
const termsAndConditions = [
  ...
  },
  {
  ...
  },
   {
    ...
    description:
      "THE PLUMBING SERVICE IS FIRST INSPECTED BY THE PLUMBER, THEN CROSS-VERIFIED BY THE COMPANY TECHNICIAN AFTER THE CUSTOMER CONFIRMS THE WORK, AND FINALLY DOCUMENTED WITH CUSTOMER CARE.",
  },
