...
const initialNotifications: UserNotification[] = [
  ...
  },
  {
    ...
    message:
      "Payment for invoice #INV-2025-003 has failed. Please contact the customer.",
    type: "error",
...
const initialMessages: Record<string, Message[]> = {
  "1": [
    ...
    },
    {
      ...
      receiverId: "1",
      content:
        "The technician is scheduled to arrive tomorrow between 10 AM and 12 PM. Does that work for you?",
  ...
  "2": [
    ...
    },
    {
      ...
      receiverId: "2",
      content:
        "I'm sorry to hear that, Jane. Can you please describe which part is missing?",
                          ...
                          {messages.map((msg) => (
                            ...
                            >
                              ...
                              >
                                <p>{msg.content}</p>
                                <p
                                  className={`text-xs mt-1 ${msg.isOutgoing ? "text-cyan-50" : "text-gray-500"}`}
                                >
              ...
              <Dialog.Panel className="w-full max-w-xl transform overflow-hidden rounded-2xl bg-white p-6 text-left align-middle shadow-xl transition-all">
                ...
                <div className="mt-4">
                  <p className="text-sm text-gray-500">
                    Sending message to {selectedUsers.length} user
                  ...
                  <tr>
                    ...
                    >
                      <input
                        ...
                        checked={
                          selectedUsers.length === filteredContacts.length &&
