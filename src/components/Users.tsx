...
const initialUsers: UserData[] = [
  { id: 1, name: 'John Doe', email: 'john@example.com', role: 'admin', status: 'active', lastLogin: '2024-03-15 14:30' },
  { id: 2, name: 'Jane Smith', email: 'jane@example.com', role: 'manager', status: 'active', lastLogin: '2024-03-14 09:15' },
  { id: 3, name: 'Mike Johnson', email: 'mike@example.com', role: 'user', status: 'inactive', lastLogin: '2024-03-10 16:45' },
];

function UserDialog({ isOpen, onClose, user = null }: { isOpen: boolean; onClose: () => void; user?: UserData | null }) {
